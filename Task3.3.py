...
dict_eng = {1:'AEIOULNSTR', 2:'DG', 3:'BCMP', 4:'FHVWY', 5:'K', 6:'JX', 10:'QX'} 
text = input('введите слово - ').upper()

if isCyrillic(text):
    print(sum([k for i in text for k, v in dict_rus.items() if i in v]))
else:
    print(sum([k for i in text for k, v in dict_eng.items() if i in v]))
